...
static std::vector<menu_section> LoadMenus()
{
	...
	std::vector<menu_section>{
		{0xE100, String("Walls"), 0, 1},
		{0xE101, String("Electronics"), 0, 1},
		{0xE102, String("Powered Materials"), 0, 1},
		{0xE103, String("Sensors"), 0, 1},
		{0xE104, String("Force"), 0, 1},
		{0xE105, String("Explosives"), 0, 1},
		{0xE106, String("Gases"), 0, 1},
		{0xE107, String("Liquids"), 0, 1},
		{0xE108, String("Powders"), 0, 1},
		{0xE109, String("Solids"), 0, 1},
		{0xE10A, String("Radioactive"), 0, 1},
		{0xE10B, String("Special"), 0, 1},
		{0xE10C, String("Game Of Life"), 0, 1},
		{0xE10D, String("Tools"), 0, 1},
		{0xE734, String("Favorites"), 0, 1},
		{0xE10E, String("Decoration tools"), 0, 1},
